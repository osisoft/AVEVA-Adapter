...
| **Password**                    | Required for PI Web API endpoints   | `string`    | The password used to authenticate with a PI Web API OMF endpoint <br><br>_PI server:_<br>Allowed value: any string or a secret Id (see [Reference Secrets](xref:ReferenceSecrets))<br>Default: `null`|
