...
**Note:** As part of making adapters as secure as possible, any secret values that you configure are stored in encrypted form where cryptographic key material is stored separately in a secure location. If you edit the files directly, the adapter may not work as expected.
